...
const TimelineItem = ({ year, position, achievement }) => (
  <div className="relative pl-8 sm:pl-16 group">
    <div className="flex flex-col sm:flex-row items-baseline font-merriweather">
      <div className="text-xl font-bold text-blue-600 mb-1 sm:mb-0 sm:mr-4 font-josefin">
        {year}
      </div>
      <div className="flex-1">
        <h4 className="font-semibold text-lg text-gray-900 font-josefin">
          {position}
        </h4>
...
export default function Biography() {
  ...
  return (
    <div className="bg-gray-100 p-8 md:p-12 rounded-xl shadow-lg font-merriweather">
      <h2 className="text-3xl md:text-4xl font-bold text-gray-800 text-center mb-12 font-josefin">
      ...
      <div className="flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 mb-16">
        ...
        <div className="flex-1 text-center md:text-left">
          <h3 className="text-2xl font-bold text-gray-900 font-josefin">
            {chairman.name}
          </h3>
          <p className="text-lg text-blue-600 font-semibold font-merriweather">
            {chairman.title}
          </p>
          <p className="text-sm text-gray-500 italic mb-4 font-merriweather">
            {chairman.nickname}
          </p>
          {chairman.fullBio.map((paragraph, index) => (
            <motion.p
              key={index}
              className="text-gray-700 mb-4 leading-relaxed font-merriweather"
              variants={fadeIn}
            >
              {paragraph}
            </motion.p>
      ...
      <div className="grid md:grid-cols-2 gap-8 mb-16">
        <motion.div
          className="bg-white p-6 rounded-lg shadow-md font-merriweather"
          variants={fadeIn}
        >
          <h3 className="text-xl font-bold text-gray-800 mb-4 border-b-2 border-green-200 pb-2 font-josefin">
      ...
      <motion.section className="relative font-merriweather" variants={fadeIn}>
        <h3 className="text-2xl font-bold text-gray-800 text-center mb-8 font-josefin">
          Political Journey
        </h3>
