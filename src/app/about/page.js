...
const SectionLoader = ({ className = "" }) => (
  <motion.div
    className={`animate-pulse ${className} font-merriweather`}
    ...
    >
      <div className="max-w-4xl mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4 font-josefin">
          About Ikeja Local Government
        </h1>
        <p className="text-xl text-gray-600 max-w-2xl mx-auto font-merriweather">
          The Centre of Excellence on the Mainland
        </p>
      </div>
    </motion.div>
  );
...
const NavigationDots = ({ activeSection }) => {
  ...
  return (
    ...
    >
      <nav className="space-y-3 font-josefin">
